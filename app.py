...
def upload_predict():
    if request.method == "POST":
        ...
        if pred >= 0.5:
            print('{:.2%} probability of being Normal case'.format(pred[0][0]))
            predicted_class = 'Normal, {:.2%}'.format(pred[0][0])
        else:
            print('{:.2%} probability of being COVID case'.format(1 - pred[0][0]))
            predicted_class = 'COVID, {:.2%}'.format(1 - pred[0][0])
